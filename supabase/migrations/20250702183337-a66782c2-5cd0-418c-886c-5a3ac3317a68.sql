-- Fase 2A: Popular apenas dados de teste (sem alterar user_type ainda)
...
((SELECT id FROM profiles WHERE email = 'betomanzoli@gmail.com'), 'Bem-vindo ao PharmaConnect', 'Dados de teste foram adicionados à plataforma com sucesso.', 'system', false),
