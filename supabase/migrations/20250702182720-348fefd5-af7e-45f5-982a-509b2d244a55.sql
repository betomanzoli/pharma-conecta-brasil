-- Fase 2A: Popular dados de teste e criar usuário admin
...
('Nova Resolução RDC 786/2023 - Medicamentos Genéricos', 'ANVISA publica nova resolução sobre critérios para registro de medicamentos genéricos, incluindo novos requisitos de bioequivalência', 'ANVISA', 'regulatory_update', 'high', '2024-01-15 09:00:00+00', '2024-03-15 23:59:59+00', 'https://www.anvisa.gov.br/rdc786'),
...
('Prazo Final para Adequação à RDC 780/2023', 'Lembrete sobre o prazo final para adequação dos laboratórios à nova resolução sobre boas práticas', 'ANVISA', 'deadline', 'high', '2024-01-05 10:00:00+00', '2024-01-30 23:59:59+00', 'https://www.anvisa.gov.br/rdc780'),
('Nova Lista de Medicamentos de Referência', 'Publicação da lista atualizada de medicamentos de referência para estudos de bioequivalência', 'ANVISA', 'reference_list', 'medium', '2024-01-03 16:00:00+00', NULL, 'https://www.anvisa.gov.br/medicamentos-referencia');
...
-- Criar perfil admin de teste (será usado para criar um usuário admin posteriormente)
-- Primeiro, vamos atualizar o perfil existente betomanzoli@gmail.com para admin temporariamente
