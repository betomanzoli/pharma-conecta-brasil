-- Fase 2A: Popular dados de teste e criar usuário admin (corrigido)
...
-- Inserir dados de teste para regulatory_alerts (usando tipos válidos: recall, approval, guideline)
...
('Aprovação de Novo Medicamento Oncológico', 'ANVISA aprova novo medicamento para tratamento de câncer de mama em estágio avançado', 'ANVISA', 'approval', 'high', '2024-01-05 10:00:00+00', NULL, 'https://www.anvisa.gov.br/novo-onco'),
