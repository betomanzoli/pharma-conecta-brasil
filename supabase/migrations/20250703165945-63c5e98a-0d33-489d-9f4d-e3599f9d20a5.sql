-- Fase 2D: Sistema de Notificações Real (corrigido)
...
-- Inserir algumas notificações de exemplo com tipos válidos
INSERT INTO public.notifications (user_id, title, message, type) VALUES
((SELECT id FROM profiles WHERE email = 'betomanzoli@gmail.com'), 'Bem-vindo à Plataforma!', 'Sua conta foi criada com sucesso. Explore todas as funcionalidades disponíveis.', 'info'),
((SELECT id FROM profiles WHERE email = 'betomanzoli@gmail.com'), 'Novo Alerta Regulatório', 'A ANVISA publicou uma nova regulamentação sobre medicamentos genéricos.', 'warning'),
((SELECT id FROM profiles WHERE email = 'betomanzoli@gmail.com'), 'Atualização do Sistema', 'Nova versão da plataforma disponível com melhorias de performance.', 'info'),
((SELECT id FROM profiles WHERE email = 'betomanzoli@gmail.com'), 'Recurso Popular', 'Seu guia de registro na ANVISA atingiu 1000 downloads!', 'success');